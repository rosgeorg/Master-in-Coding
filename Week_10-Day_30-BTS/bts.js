...
class Tree {
  ...
  add(dato) {
    ...
    while (true) {
      //loop infinito aqui es donde se empieza a buscar
      if (dato < currentNode.dato) {
        ...
        //si no va a la izquierda va a la derecha
  ...
  contains(dato) {
    ...
    while (currentNode !== null) {
      //Mientras haya un current node  se ejecuta esto
      if (dato === currentNode.dato) {
        return true;
      } else {
        if (dato < currentNode.dato) {
